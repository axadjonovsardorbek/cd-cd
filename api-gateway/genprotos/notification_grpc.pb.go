...
func (c *serviceNotificationClient) Create(ctx context.Context, in *CreateNotification, opts ...grpc.CallOption) (*Void, error) {
	out := new(Void)
	err := c.cc.Invoke(ctx, ServiceNotification_Create_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *serviceNotificationClient) GetByUserId(ctx context.Context, in *GetAllRequest, opts ...grpc.CallOption) (*GetAllResponse, error) {
	...
	err := c.cc.Invoke(ctx, ServiceNotification_GetByUserId_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *serviceNotificationClient) ReadeAll(ctx context.Context, in *ReadeAllRequest, opts ...grpc.CallOption) (*Void, error) {
	out := new(Void)
	err := c.cc.Invoke(ctx, ServiceNotification_ReadeAll_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *serviceNotificationClient) SendAll(ctx context.Context, in *SendByCompanyidToUsers, opts ...grpc.CallOption) (*Void, error) {
	out := new(Void)
	err := c.cc.Invoke(ctx, ServiceNotification_SendAll_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
