...
func (c *vacancyServiceClient) Create(ctx context.Context, in *VacancyCreate, opts ...grpc.CallOption) (*Void, error) {
	out := new(Void)
	err := c.cc.Invoke(ctx, VacancyService_Create_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *vacancyServiceClient) GetByID(ctx context.Context, in *Byid, opts ...grpc.CallOption) (*VacancyGetResUpdateReq, error) {
	...
	err := c.cc.Invoke(ctx, VacancyService_GetByID_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *vacancyServiceClient) Update(ctx context.Context, in *VacancyGetResUpdateReq, opts ...grpc.CallOption) (*Void, error) {
	out := new(Void)
	err := c.cc.Invoke(ctx, VacancyService_Update_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *vacancyServiceClient) Delete(ctx context.Context, in *Byid, opts ...grpc.CallOption) (*Void, error) {
	out := new(Void)
	err := c.cc.Invoke(ctx, VacancyService_Delete_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *vacancyServiceClient) GetAll(ctx context.Context, in *VacancyGetAllReq, opts ...grpc.CallOption) (*VacancyGetAllRes, error) {
	...
	err := c.cc.Invoke(ctx, VacancyService_GetAll_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
